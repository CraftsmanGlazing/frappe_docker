...
for container in ${container_array[@]}; do
        echo $container
        #docker exec ${container} bench get https://github.com/frappe/hrms.git --branch version-15 --resolve-deps & ## --resolve-deps fails if you use custom ERP module
        docker exec ${container} bench get https://github.com/frappe/hrms.git --branch version-15 &
done
wait
#Installing App
